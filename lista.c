...
/**
 * Destruye (libera la memoria reservada) la lista [l] y todos los elementos que
 * almacena.
 *
 ...
 */
int esListaVacia(TLISTA l) { return (l->longitud == 0); }
 ...
 */
TPOSICION primeroLista(TLISTA l) { return l->inicio; }
 ...
 */
TPOSICION finLista(TLISTA l) { return l->fin; }
 ...
 */
TPOSICION siguienteLista(TLISTA l, TPOSICION p) { return p->sig; }
 ...
 */
int longitudLista(TLISTA l) { return l->longitud; }

/**
 * Inserta el elemento [e] en la posicion siguiente a la posicion [p] de la
 * lista [l].
 *
...
/**
 * Modifica el valor del elemento almacenado en la posicion [p] guardando el
 * nuevo elemento [e].
 *
